...
public interface LitemallAdMapper {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    LitemallAd selectOneByExampleWithBLOBs(LitemallAdExample example);
     ...
     * @mbg.generated
     */
    List<LitemallAd> selectByExampleWithBLOBs(LitemallAdExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("record") LitemallAd record, @Param("example") LitemallAdExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeyWithBLOBs(LitemallAd record);
