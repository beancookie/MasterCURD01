 ...
 <el-form :model="ruleForm"   ref="ruleForm" label-width="100px" class="demo-ruleForm"  >
  ...
  <el-form-item label="眼镜价格" prop="glassPrice" required>
     ...
     <el-input v-model="ruleForm.glassPrice"></el-input> 
      ...
      <el-input-number v-model="ruleForm.grassNum" @change="handleChange" :min="1" :max="10" label="描述文字"></el-input-number>
        </el-col >
  </el-form-item>
...
<el-form-item label="购买日期" required prop="glassDate">
    <el-col :span="11">
      <el-form-item >
        <el-date-picker type="date" placeholder="选择日期" v-model="ruleForm.glassDate" style="width: 100%;"></el-date-picker>
      </el-form-item>
    </el-col>
...
<el-row>
 <el-col :span="10" :offset="8">
 <el-form :model="ruleForm1"  inline=true ref="ruleForm1" label-width="100px" class="demo-ruleForm"  >
...
<el-row>
 <el-col :span="10" :offset="8">
 <el-form :model="ruleForm2"  inline=true  ref="ruleForm2" label-width="100px" class="demo-ruleForm"  >
...
<el-row>
 <el-col :span="10" :offset="8">
 <el-form :model="ruleForm3"   inline=true  ref="ruleForm3" label-width="100px" class="demo-ruleForm"  >
